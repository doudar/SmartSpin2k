...
We have identified an issue with auto updates.  After a factory reset, you will not be able to access the configuration screen.  We advise users to flash the latest version of the 2.6.26 firmware, [available here](https://github.com/doudar/SmartSpin2k/releases/download/2.6.26/firmware.bin).  Flashing instructions are available on the [Wiki](https://github.com/doudar/SmartSpin2k/wiki/Loading-Software)
