...
If you'd like to build the PCB version, you can directly order the PCB from https://www.pcbway.com/project/shareproject/SmartSpin2k_PCB.html and omit the LM2596 from above. (But follow the PCB BOM on the link).
