...
String noIndexHTML =
    ...
    "      <table border='0' style='height: 30px; width: 50%; border-collapse: collapse; border-style: none;'"
    ...
    "            </td>"
    "            <td style='width: 200px; height: 20px;'><input type='text' id='ssid' name='ssid' value='' /></td>"
    "          </tr>"
    "          <tr style='height: 20px;'>"
    "            <td style='width: 14%; height: 20px;'>"
    "              <p><label for='password'>Password</label></p>"
    "            </td>"
    "            <td style='width: 200px; height: 20px;'><input type='text' id='password' name='password' value='' />"
    "            </td>"
    "          </tr>"
    "          </tr>"
    "        </tbody>"
