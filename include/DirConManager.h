...
#define DIRCON_RECEIVE_BUFFER_SIZE 1024
#define DIRCON_SEND_BUFFER_SIZE 1024
#define DIRCON_NOTIFICATION_INTERVAL 200 // ms interval for sending notifications
...
public:
    ...
    static void notifyCharacteristic(const NimBLEUUID& serviceUuid, const NimBLEUUID& characteristicUuid,
...
private:
    ...
    static bool clientSubscriptions[DIRCON_MAX_CLIENTS][100]; // Simple subscription tracking (up to 100 characteristics)
